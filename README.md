...
Pour cloner et démarrer ce répertoire il vous faudra [Git](https://git-scm.com) and [Node.js](https://nodejs.org/en/download/) (which comes with [npm](http://npmjs.com)) installer sur votre PC. Depuis votre ligne de commande:
